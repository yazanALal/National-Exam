...
use App\Rules\CheckFavoriteRule;
use App\Rules\CheckQuestionCollegeRule;
...
class AddFavoriteRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            'question'=>[
                'required','integer','exists:exam_questions,id',
                new CheckFavoriteRule, 
                new CheckQuestionCollegeRule($this)
            ],
        ];
    }
